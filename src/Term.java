...
public class Term {
    ...
    /**
     * The number of documents this term has appeared in.
     */
    ...
    /**
     * @return The number of documents this Term has appeared in.
     */
    ...
    public void incFrequency(String docName) {
        this.totalFrequency++;  //Increment the total frequency of the Term.
        ...
        for (int i = 0; i < docsList.size(); i++)  {	//Iterate through the entire list
            ...
            if (o.equals(newDoc)) {						//If the new one matches the current one...
                o.incFrequency();						//...increment the frequency of the occurrence...
                return;									//...& GTFO.
                ...
                this.docFrequency++;					//...increment the Term's document counter...
                return;									//...& GTFO.
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%d document(s) contain \"%s\" a total of %d times.\n", test.getDocFrequency(), test, test.getTotalFrequency());
